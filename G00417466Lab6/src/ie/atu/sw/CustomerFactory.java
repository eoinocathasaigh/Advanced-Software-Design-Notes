...
//This is the observer pattern at work here
//We declare an observable list for the model for our table
//The concrete strategy we're using is also the observer list - model also becomes a subject
public class CustomerFactory {
	...
	//When we call getCustomers it will return to us the observable list of peoplewe can use
