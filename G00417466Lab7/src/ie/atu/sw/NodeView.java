...
//This is the canvas for this application
public class NodeView extends Canvas{
	//We store the picture as a 2d array
	...
	//This isnt a callback method
	//What we're doing is looping over the rows and columns and each time we call the visitor for this particular node/position
	public void paint() {
